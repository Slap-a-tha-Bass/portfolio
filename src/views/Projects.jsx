                        ...
                        <div className="card-body card-header-info">
                            <div className="card-text">
                                <ul className="list-group">
                                    <li className="list-group-item card-header-warning text-light border-dark">Sole creator and engineer of this full-stack application, inspired by my love for coffee</li>
                                    ...
                                    <li className="list-group-item card-header-warning text-light border-dark">Users have the ability to place an order with any combination of snacks or drinks using CRUD REST api functions</li>
                                    <li className="list-group-item card-header-warning text-light border-dark">Several hooks are experimented with in this project, ie useForm() for form handling and apiService() for CRUD applications</li>
                                    <li className="list-group-item card-header-warning text-light border-dark">Server functions handle all of the math and sorting the orders placed so that the correct price is displayed</li>
                                    <li className="list-group-item card-header-warning text-light border-dark">Stripe integration for handling a mock-purchase sends receipt information to a stored api procedure</li>
